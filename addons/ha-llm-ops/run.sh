...
if [ -f "$CONFIG_PATH" ]; then
  ...
  PROBLEM_DIR=$(jq -r '.problem_dir // "/data/problems"' "$CONFIG_PATH")
  ...
  PROBLEM_DIR=${PROBLEM_DIR:-/data/problems}
...
export LOG_LEVEL BUFFER_SIZE PROBLEM_DIR LLM_BACKEND OPENAI_API_KEY HA_WS_URL
